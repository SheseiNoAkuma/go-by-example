...
import (
	...
	"github.com/microhatesyou/go-by-example/http-rest-api-server/pkg/swagger/server/restapi/operations"
)

//go:generate swagger generate server --target ../../server --name SwaggerAPI --spec ../../swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.SwaggerAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SwaggerAPIAPI) http.Handler {
